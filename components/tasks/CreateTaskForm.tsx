...
export function CreateTaskForm({ groupId }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
      {error && (
        <div className="p-3 lg:p-4 bg-red-500/20 border border-red-500 rounded-lg text-red-300 text-sm flex items-start gap-2">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 lg:px-4 py-2 lg:py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors resize-none text-sm lg:text-base"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full px-3 lg:px-4 py-2 lg:py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-colors text-sm lg:text-base"
        >
