    ...
    <div className="space-y-6 lg:space-y-8">
      ...
      <div className="grid sm:grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
        ...
        <Card className="p-4 lg:p-6">
          ...
          <div className="space-y-4 lg:space-y-6">
            <div className="p-4 lg:p-6 bg-gradient-to-r from-red-500/10 to-red-600/10 border border-red-500/20 rounded-lg">
              <p className="text-sm text-gray-400 mb-2">Total Tasks Created</p>
              <p className="text-3xl lg:text-4xl font-bold text-red-500">{totalTasks || 0}</p>
            </div>
