...
export default function Home() {
  return (
    <div className="min-h-screen bg-black">
      {/* Navigation */}
      <nav className="border-b border-gray-800 sticky top-0 z-50 bg-black/95 backdrop-blur supports-backdrop-blur:bg-black/60">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center">
          ...
          <p className="text-lg lg:text-xl text-gray-400 mb-8 lg:mb-12 max-w-3xl mx-auto leading-relaxed">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          <Card className="text-center p-6 lg:p-8">
            <div className="mb-4 lg:mb-6">
              <div className="w-12 h-12 lg:w-16 lg:h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto">
